  ...
  <body>
    ...
    <footer class="page-footer">
      <div class="footer-copyright">
        <div class="container">
          <span>Copyright © DBMS <a class="grey-text text-lighten-4" href="#" target="_blank">F2 - PF18, PF21, PF23</a> All rights reserved.</span>
          <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#"> F2 gang</a></span>
        </div>
      </div>
    </footer>
    <!-- END FOOTER -->
